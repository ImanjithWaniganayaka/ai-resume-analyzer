...
const Upload = () => {
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        const form = e.currentTarget; // already the form element
            ...
            <section className="main-section">
                <div className="page-heading py-16">
                    ...
                    {isProcessing ? (
                        ...
                        <h2>Drop your resume for as ATS score and improvement tips</h2>
                    )}
                    {!isProcessing && (
                        <form id="upload-form" onSubmit={handleSubmit} className="flex-col gap-4 mt-8">
